 ...
 *   but WITHOUT ANY WARRANTY; without even the miosix/config/arch/arm7_lpc2000/lpc2138_miosix_board/board_settings.hmiosix/config/arch/arm7_lpc2000/lpc2138_miosix_board/board_settings.himplied warranty of        *
...
/// gba has 32KB of IWRAM so there is room for a big 4K stack.
const unsigned int MAIN_STACK_SIZE=4*1024;

/// \internal Clock frequency of hardware timer, hardware specific data
const unsigned int TIMER_CLOCK=16780000;
